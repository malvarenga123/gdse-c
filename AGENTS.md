...
- Run from the game directory: `./gdse [--language en] [--out PATH] [--rainbow-filter-damage-colors]`; alternatively pass `/path/to/game` as the optional first positional argument.
